...
namespace ThisOtherThing.UI
{
	public class GeoUtils
	{
		...
		public class RoundingProperties
		{
			...
			[UnityEngine.MinAttribute(2)]public int FixedResolution = 10;
			[UnityEngine.MinAttribute(0.01f)]public float ResolutionMaxDistance = 4.0f;
		...
		public class ShadowsProperties
		{
			...
			[UnityEngine.MinAttribute(0.0f)] public float Distance = 0.0f;
		...
		public class ShadowProperties
		{
			...
			[UnityEngine.MinAttribute(0.0f)] public float Size = 5.0f;
